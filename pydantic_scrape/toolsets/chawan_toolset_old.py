...
class ChawanContext(BaseModel):
    ...
    def set_current_page(self, url: str, title: str = None, content_length: int = 0, link_count: int = 0, form_count: int = 0):
    ...
    def render_state(self) -> str:
        """Render current browsing state as JSON"""
